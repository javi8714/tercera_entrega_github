...
import { CartsService, cartService } from "../services/carts.service..js";
...
export class TicketsController{
    static async createTicket(req,res){
        try {
            ...
            const ticketCreated = await TicketsService.createTicket(infoticket);
        } catch (error) {
            res.json({status:"error", message:error.messsage});
        }
    }
